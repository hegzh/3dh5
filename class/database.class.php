...
class MysqliDb
{
    ...
    /**
     * Dynamic array that holds a combination of where condition/table data value types and
    ...
    public $count = 0;
    /**
     * Variable which holds an amount of returned rows during get/getOne/select queries with
     * withTotalCount()
     * @var string
     */
    public $totalCount = 0;
     ...
     * This method does not escape strings by default so make sure you'll never use it in
     * production.
     *
    ...
    /**
     * This method allows you to specify multiple (method chaining optional) options for SQL
     * queries.
     *
     ...
     *
     * @param string $tableName The name of the table.
     * @param array $multiInsertData Two-dimensinal Data-array containing information for inserting
     *     into the DB.
     * @param array $dataKeys Optinal Table Key names, if not set in insertDataSet.
     *
     * @return bool|array Boolean indicating the insertion failed (false), else return id-array
     *     ([int])
     */
    ...
    /**
     * This method allows you to specify multiple (method chaining optional) AND WHERE statements
     * for SQL queries.
     *
    ...
    /**
     * This method allows you to specify multiple (method chaining optional) OR WHERE statements
     * for SQL queries.
     *
    ...
    /**
     * This method allows you to specify multiple (method chaining optional) AND HAVING statements
     * for SQL queries.
     *
    ...
    /**
     * This method allows you to specify multiple (method chaining optional) OR HAVING statements
     * for SQL queries.
     *
     ...
     * Please check out http://dev.mysql.com/doc/refman/5.7/en/load-data.html for a valid .csv
     * file.
     * @author Jonas Barascu (Noneatme)
     *
     * @param string $importTable The database table where the data will be imported into.
     * @param string $importFile The file to be imported. Please use double backslashes \\ and make
     *     sure you
    ...
    /**
     * This method allows you to specify multiple (method chaining optional) ORDER BY statements
     * for SQL queries.
     *
    ...
    /**
     * This method allows you to specify multiple (method chaining optional) GROUP BY statements
     * for SQL queries.
     *
     ...
     *
     * Array Returns an array($k => $v) if get(.."param1, param2"), array ($k => array ($v, $v))
     * otherwise
     *
    ...
    /**
     * This method allows you to specify multiple (method chaining optional) AND WHERE statements
     * for the join table on part of the SQL query.
     *
