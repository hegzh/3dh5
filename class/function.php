...
function check_level($level, $ajax = 0, $return = 0)
{
    ...
    foreach ($user_no_level as $v)
    {
        if (isset($level_all[$v]))
        {
            unset($level_all[$v]);
        }
    }
...
//postCurl方法
function postCurl($url, $body, $header = [], $method = "POST")
{
