...
<div id="panelwrap">
    ...
    <form action="javascript:void(0)" name="pro_form" data-submit="adp.php?m=addpro"
          onsubmit="pro_submit(this)">
                ...
                <div id="right_content">
                    ...
                    <div class="form">
                        ...
                        <div class="form_row">
                            ...
                            -->
                            <div class="message">
                                <input type="button" value="选择产品" size="30" class="liulan"
                                       id="profile">
                                <input type="text" id="profileurl" name="profileurl" class="input"
                                       value="" disabled="disabled" style="display: inline;"/>
                            </div>
                        </div>

                        <input type="text" id="archive" name="archive" value="1"
                               style="display:none"/>
                        <div class="form_row">
...
<script src="<?php echo __JS__; ?>/jquery.ajaxupload.js" type="text/javascript"
...
<script>
    ...
    function pro_submit(obj) {
        ...
        if (pro_name == '') {
            alert('请输入产品名称');
            proObj.pro_name.focus();
            return;
        }
        if (pro_category == '') {
            alert('请选择产品分类');
            proObj.pro_category.focus();
            return;
        }
        if (profileurl == '') {
            alert('请上传产品压缩包（只支持zip格式）');
            proObj.profileurl.focus();
            return;
        }
        $.ajax({
            type: "post",
